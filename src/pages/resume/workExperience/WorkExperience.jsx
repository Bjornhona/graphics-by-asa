  ...
  return (
    <div id="home-inner-container">
      ...
      <div>
        ...
        <p>Designing and developing large-scale, client-specific web applications from concept to production. Frontend ownership across React and React Native projects, close collaboration with product and design, and long-term maintenance of complex codebases. JavaScript, React, React Native, Jest, Agile, Jira, Figma, Sketch, Adobe XD.</p>
